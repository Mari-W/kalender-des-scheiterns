...
class UAgentInfo(userAgent: String?, httpAccept: String?) {
    ...
    fun detectIphone(): Boolean {
        ...
        return if (userAgent.indexOf(deviceIphone) != -1 &&
            !detectIpad() &&
            !detectIpod()
        ) {
            true
    ...
    fun detectIpod(): Boolean {
        return if (userAgent.indexOf(deviceIpod) != -1) {
            true
        } else false
    }
    ...
    fun detectIpad(): Boolean {
        return if (userAgent.indexOf(deviceIpad) != -1
            && detectWebkit()
        ) {
            true
        } else false
    ...
    fun detectIos(): Boolean {
        return if (detectIphoneOrIpod() || detectIpad()) {
            true
        } else false
    }
    ...
    fun detectAndroid(): Boolean {
        return if (userAgent.indexOf(deviceAndroid) != -1 ||
            detectGoogleTV()
        ) true else false
    }
    ...
    fun detectAndroidPhone(): Boolean {
        ...
        return if (detectOperaMobile()) true else false
    }
    ...
    fun detectAndroidTablet(): Boolean {
        ...
        return if (userAgent.indexOf(mobile) > -1) false else true
    }
    ...
    fun detectAndroidWebKit(): Boolean {
        return if (detectAndroid() && detectWebkit()) {
            true
        } else false
    }
    ...
    fun detectGoogleTV(): Boolean {
        return if (userAgent.indexOf(deviceGoogleTV) != -1) {
            true
        } else false
    }
    ...
    fun detectWebkit(): Boolean {
        return if (userAgent.indexOf(engineWebKit) != -1) {
            true
        } else false
    }
    ...
    fun detectSymbianOS(): Boolean {
        return if (userAgent.indexOf(deviceSymbian) != -1 || userAgent.indexOf(deviceS60) != -1 || userAgent.indexOf(
                deviceS70
            ) != -1 || userAgent.indexOf(deviceS80) != -1 || userAgent.indexOf(deviceS90) != -1
        ) {
            true
        } else false
    }
    ...
    fun detectWindowsPhone7(): Boolean {
        return if (userAgent.indexOf(deviceWinPhone7) != -1) {
            true
        } else false
    }
    ...
    fun detectWindowsPhone8(): Boolean {
        return if (userAgent.indexOf(deviceWinPhone8) != -1) {
            true
        } else false
    }
    ...
    fun detectWindowsPhone10(): Boolean {
        return if (userAgent.indexOf(deviceWinPhone10) != -1) {
            true
        } else false
    }
    ...
    fun detectWindowsMobile(): Boolean {
        ...
        if (userAgent.indexOf(deviceWinMob) != -1 || userAgent.indexOf(deviceWinMob) != -1 || userAgent.indexOf(
                deviceIeMob
            ) != -1 || userAgent.indexOf(enginePie) != -1 || userAgent.indexOf(manuHtc) != -1 && userAgent.indexOf(
                deviceWindows
            ) != -1
        ...
        return if (userAgent.indexOf(devicePpc) != -1 &&
    ...
    fun detectBlackBerry(): Boolean {
        ...
        return if (detectBlackBerry10Phone()) true else false
    }
    ...
    fun detectBlackBerry10Phone(): Boolean {
        return if (userAgent.indexOf(deviceBB10) != -1 &&
    ...
    fun detectBlackBerryTablet(): Boolean {
        return if (userAgent.indexOf(deviceBBPlaybook) != -1) {
            true
        } else false
    }
    ...
    fun detectBlackBerryTouch(): Boolean {
        return if (detectBlackBerry() &&
            (userAgent.indexOf(deviceBBStorm) != -1 || userAgent.indexOf(deviceBBTorch) != -1 || userAgent.indexOf(
                deviceBBBoldTouch
            ) != -1 || userAgent.indexOf(deviceBBCurveTouch) != -1)
        ) {
            true
        } else false
    }
    ...
    fun detectBlackBerryHigh(): Boolean {
        ...
        return if (detectBlackBerry()) {
            if (detectBlackBerryTouch()
                || userAgent.indexOf(deviceBBBold) != -1 || userAgent.indexOf(deviceBBTour) != -1 || userAgent.indexOf(
                    deviceBBCurve
                ) != -1
            ) {
                true
    ...
    fun detectPalmWebOS(): Boolean {
        return if (userAgent.indexOf(deviceWebOS) != -1) {
            true
        } else false
    }
    ...
    fun detectWebOSTablet(): Boolean {
        return if (userAgent.indexOf(deviceWebOShp) != -1 &&
    ...
    fun detectWebOSTV(): Boolean {
        return if (userAgent.indexOf(deviceWebOStv) != -1 &&
    ...
    fun detectOperaMobile(): Boolean {
        return if (userAgent.indexOf(engineOpera) != -1
    ...
    fun detectKindle(): Boolean {
        return if (userAgent.indexOf(deviceKindle) != -1 &&
            !detectAndroid()
        ) {
            true
        } else false
    ...
    fun detectAmazonSilk(): Boolean {
        return if (userAgent.indexOf(engineSilk) != -1) {
            true
        } else false
    }
    ...
    fun detectGarminNuvifone(): Boolean {
        return if (userAgent.indexOf(deviceNuvifone) != -1) {
            true
        } else false
    }
    ...
    fun detectBada(): Boolean {
        return if (userAgent.indexOf(deviceBada) != -1) {
            true
        } else false
    }
    ...
    fun detectTizen(): Boolean {
        return if (userAgent.indexOf(deviceTizen) != -1 &&
            userAgent.indexOf(mobile) != -1
        ) {
            true
        } else false
    ...
    fun detectMeego(): Boolean {
        return if (userAgent.indexOf(deviceMeego) != -1) {
            true
        } else false
    }
    ...
    fun detectFirefoxOS(): Boolean {
        return if (detectFirefoxOSPhone() || detectFirefoxOSTablet()) true else false
    }
    ...
    fun detectFirefoxOSPhone(): Boolean {
        ...
        return if (userAgent.indexOf(engineFirefox) != -1
            && userAgent.indexOf(mobile) != -1
        ) true else false
    }
    ...
    fun detectSailfish(): Boolean {
        return if (userAgent.indexOf(deviceSailfish) != -1) {
            true
        } else false
    }
    ...
    fun detectSailfishPhone(): Boolean {
        return if (detectSailfish() && userAgent.indexOf(mobile) != -1) true else false
    }
    ...
    fun detectUbuntu(): Boolean {
        return if (detectUbuntuPhone() || detectUbuntuTablet()) true else false
    }
    ...
    fun detectUbuntuPhone(): Boolean {
        return if (userAgent.indexOf(deviceUbuntu) != -1
            && userAgent.indexOf(mobile) != -1
        ) true else false
    }
    ...
    fun detectDangerHiptop(): Boolean {
        return if (userAgent.indexOf(deviceDanger) != -1
    ...
    fun detectSonyMylo(): Boolean {
        return if (userAgent.indexOf(manuSony) != -1
    ...
    fun detectArchos(): Boolean {
        return if (userAgent.indexOf(deviceArchos) != -1) {
            true
        } else false
    }
    ...
    fun detectGameConsole(): Boolean {
        return if (detectSonyPlaystation()
            || detectNintendo()
            || detectXbox()
        ) {
            true
    ...
    fun detectSonyPlaystation(): Boolean {
        return if (userAgent.indexOf(devicePlaystation) != -1) {
            true
        } else false
    }
    ...
    fun detectNintendo(): Boolean {
        return if (userAgent.indexOf(deviceNintendo) != -1 || userAgent.indexOf(deviceWii) != -1 || userAgent.indexOf(
                deviceNintendoDs
            ) != -1
        ) {
            true
    ...
    fun detectXbox(): Boolean {
        return if (userAgent.indexOf(deviceXbox) != -1) {
            true
        } else false
    }
    ...
    fun detectBrewDevice(): Boolean {
        return if (userAgent.indexOf(deviceBrew) != -1) {
            true
        } else false
    }
    ...
    fun detectWapWml(): Boolean {
        return if (httpAccept.indexOf(vndwap) != -1
    ...
    fun detectMidpCapable(): Boolean {
        return if (userAgent.indexOf(deviceMidp) != -1
    ...
    fun detectMobileQuick(): Boolean {
        ...
        return if (userAgent.indexOf(engineNetfront) != -1
    ...
    fun detectMobileLong(): Boolean {
        ...
        return if (userAgent.indexOf(uplink) != -1
